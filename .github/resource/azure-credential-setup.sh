...
gh --repo ${PARAM_USER_NAME}/azure.liberty.aks secret set "AZURE_CREDENTIALS" -b"${AZURE_CREDENTIALS}"
gh --repo ${PARAM_USER_NAME}/azure.liberty.aks variable set "AZURE_CREDENTIALS_SP_NAME" -b"${AZURE_CREDENTIALS_SP_NAME}"
