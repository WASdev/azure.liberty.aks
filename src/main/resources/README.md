...
- When submitting the offer, use content from [this directory](https://github.com/WASdev/azure.liberty.aks/tree/master/src/main/resources) (To-Be-Changed), but apply the changes in this file on top

## New offer

- Offer ID
  - 20210924-liberty-aks
- Offer alias
...
- [marketing-artifacts](https://github.com/WASdev/azure.liberty.aks/tree/master/src/main/resources/marketing-artifacts)
  - Small: 48*48
  - Medium: 90*90
  - Large: 216*216
  - Wide: 255*115
